...
#  cdecl
#  if defined(windows)
#    define libname "libOVRRT64_0.dll"
#  elif defined(macosx)
#    define libname "libOVRRT64_0.dylib"
#  else
#    define libname "libOVRRT64_0.so.5"
#  endif
#endif
...
#endif
#else
  #def OVR_PUBLIC_FUNCTION(rval)
  #def OVR_PUBLIC_CLASS
  #def OVR_PRIVATE_FUNCTION
  #def OVR_PRIVATE_CLASS
#endif
